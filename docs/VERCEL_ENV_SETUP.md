...
3. 다음 환경 변수 추가:
   ...
   - **Value**: `b5e49ad3180f5e9a82c084ac5ba27a80078fcea1b43a638493c1c1ddfbe08d54` (또는 실제 API 키)
...
3. 해당 Application (Client ID: `c7oir7qw85`) 클릭
...
2. 다음 환경 변수 확인:
   ...
   - **Value**: `c7oir7qw85` (또는 실제 Client ID)
   - **Environment**: Production, Preview, Development 모두 선택
3. 값이 올바른지 확인 후 **Save**
...
| 변수명 | 설명 | 예시 |
|--------|------|------|
| `GOCAMPING_API_KEY` | 고캠핑 API 키 (서버 사이드 전용) | `b5e49ad3180f5e9a82c084ac5ba27a80078fcea1b43a638493c1c1ddfbe08d54` |
...
| 변수명 | 설명 | 예시 |
|--------|------|------|
| `NEXT_PUBLIC_NAVER_MAP_CLIENT_ID` | Naver Map API Client ID | `c7oir7qw85` |
...
```bash
# .env.local
GOCAMPING_API_KEY=b5e49ad3180f5e9a82c084ac5ba27a80078fcea1b43a638493c1c1ddfbe08d54
NEXT_PUBLIC_NAVER_MAP_CLIENT_ID=c7oir7qw85
```
